...
def make_keys():
    ...
    # Step 4: Update (C1, D1), ..., (C16, D16)     (update variables dynamically)
    for i in range(1, 17):
    ...
    # Step 8: Output
    output_arr = [k1_str, k2_str, k3_str, k4_str, k5_str, k6_str, k7_str, k8_str, k9_str, k10_str, k11_str, k12_str,
                  k13_str, k14_str, k15_str, k16_str]
